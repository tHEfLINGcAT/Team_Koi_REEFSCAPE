...
public class ArmSubsystem extends SubsystemBase {
    ...
    public ArmSubsystem() {
        pidController = new PIDController(Constants.ArmConstants.Kp, Constants.ArmConstants.Ki,
    ...
    public void periodic() {
        ...
        feedforward = new ArmFeedforward(Constants.ArmConstants.Ks, Constants.ArmConstants.Kg,
